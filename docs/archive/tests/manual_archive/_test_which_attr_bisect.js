...
(async () => {
  ...
  // Test A: data-volume + data-start only (no data-duration)
  ...
  console.log('TEST A (data-volume + data-start only):', testA.audioMuted === false ? 'PASS' : 'FAIL');

  // Test B: data-volume + data-duration only (no data-start)
  ...
  console.log('TEST B (data-volume + data-duration only):', testB.audioMuted === false ? 'PASS' : 'FAIL');

  // Test C: data-volume + data-track-index only
  ...
  console.log('TEST C (data-volume + data-track-index only):', testC.audioMuted === false ? 'PASS' : 'FAIL');
