...
ROLE_NARRATION_OVERRIDE: dict[str, list[tuple[tuple[str, ...], str]]] = {
    "method": [
        ...
        (("步骤", "阶梯", "从 0", "从 0 到", "从 0 到 1"), METHOD_STEP_LADDER["id"]),
        (("时间线", "里程碑", "roadmap", "roadmap", "90 天"), METHOD_TIMELINE_PATH["id"]),
        (("工具", "三件套", "搭起来", "工具堆栈"), METHOD_TOOL_STACK["id"]),
    ],
    "explain": [
        ...
        (("时间线", "里程碑", "roadmap"), METHOD_TIMELINE_PATH["id"]),
        (("工具", "三件套", "搭起来"), METHOD_TOOL_STACK["id"]),
        (("案例", "学员", "同学", "博主", "账号", "李同学"), EVIDENCE_CASE_STUDY_CARD["id"]),
    ],
    "evidence": [
        (("数据", "指标", "增长", "对比", "提升", "效率", "完播率"), EVIDENCE_METRIC_DASHBOARD["id"]),
        (("具体案例", "案例研究", "设计师", "自由职业", "真实案例"), EVIDENCE_CASE_STUDY["id"]),
        (("案例", "学员", "同学", "博主", "账号", "李同学"), EVIDENCE_CASE_STUDY_CARD["id"]),
        (("进度", "曲线", "周", "每周", "能力曲线"), EVIDENCE_PROGRESS_TRACKER["id"]),
        (("证据", "四项", "独立", "独立证据", "测试"), EVIDENCE_CARDS["id"]),
    ],
    "proof": [
        ...
        (("得分", "打分", "评分", "评估", "准则"), PROOF_SCORE_PANEL["id"]),
        (("下一步", "next", "step", "行动", "接下来"), PROOF_NEXT_STEP_BOARD["id"]),
    ],
    "hook": [
        (("还剩", "倒计时", "最后", "最后几天", "3 天", "2 天", "1 天"), HOOK_COUNTDOWN_STRIKE["id"]),
        (("金句", "记住", "重点是", "核心是", "关键在于"), HOOK_KEYWORD_PUNCHLINE["id"]),
        (("搞错", "误区", "真相", "不要以为", "myth"), HOOK_MYTH_BUST["id"]),
        (("前后", "反", "对比", "反差", "从 5"), HOOK_BEFORE_AFTER_FLASH["id"]),
    ],
    "pain": [
        (("数据", "状态", "表", "清单", "列表"), PAIN_DATA_DENSE_TABLE["id"]),
        (("时间线", "三个月", "代价", "积累", "恶化"), PAIN_TIMELINE_PAIN["id"]),
    ],
    "cta": [
        (("金句", "记住", "总结一句", "一句话", "quote"), CTA_QUOTE_CLOSE["id"]),
        (("评论", "邀请", "留言", "告诉我", "互动"), CTA_COMMENT_INVITE["id"]),
    ],
}
